...
class SecondFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        arguments?.let {
            ...
            if (binding.argText.text == "Image 1"){
                binding.imageView4.setImageResource(R.drawable.android_image_1)
            }
            if (binding.argText.text == "Image 2"){
                binding.imageView4.setImageResource(R.drawable.android_image_2)
            }
            if (binding.argText.text == "Image 3"){
                binding.imageView4.setImageResource(R.drawable.android_image_3)
            }
        }
